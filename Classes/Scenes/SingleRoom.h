...
#ifndef __CrossWordClient__SingleRoom__
#define __CrossWordClient__SingleRoom__
...
class SingleRoom : public cocos2d::CCLayer, public cocos2d::extension::CCBSelectorResolver, public cocos2d::extension::CCBMemberVariableAssigner
{
public:
    SingleRoom();
    ~ SingleRoom();
    ...
    /*!
     * @brief	创建一个SingleRoom实例。
     */
    static SingleRoom* create();
